...
class inSALMOPlugin:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/cell_file_maker/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Cell File Generator'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            coverStatistics = QgsZonalStatistics( gridLayer, coverLayer)
            coverStatistics.calculateStatistics(None)
            gravelStatistics = QgsZonalStatistics( gridLayer, gravelLayer)
